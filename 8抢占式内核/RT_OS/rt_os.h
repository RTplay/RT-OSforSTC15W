...
#define  OS_STAT_SEM             0x0010u    /* Pending on semaphore                                    */
#define  OS_STAT_MBOX            0x0020u    /* Pending on mailbox                                      */
#define  OS_STAT_Q               0x0040u    /* Pending on queue                                        */
#define  OS_STAT_MUTEX           0x0080u    /* Pending on mutual exclusion semaphore                   */
